...
doc_path = r"C:\Users\BARRY\Desktop\AI-WorkSpace\langgraph-course\BABOK_Guide_v3_Member_2015.pdf"
...
def grade_documents(state):
    ...
    If only one relevant document is found, return it immediately
    ...
    # If no relevant documents are found, turn on web search
    if relevant_count == 0:
