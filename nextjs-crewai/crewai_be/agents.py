...
class CompanyResearchAgents():
    ...
    def research_manager(self, companies: List[str], positions: List[str]) -> Agent:
        ...
        - Goal: Generate a list of JSON objects containing the urls for 3 recent blog articles and 
          the url and title for 3 recent YouTube interviews, for each position in each company.
        - Responsibilities:
            - Aggregate researched information into JSON objects.
            - Ensure all requested companies and positions are included.
            - Handle cases where information is not found (fill with "MISSING").
            - Continuously research until all required information is found.
            - Ensure each researched position for each company contains 3 blog articles and 3 YouTube interviews.
        """
        return Agent(
            role="Company Research Manager",
    ...
    def company_research_agent(self) -> Agent:
        ...
        - Goal: Look up the specific positions for a given company and find urls for 3 recent blog articles and 
          the url and title for 3 recent YouTube interviews for each person in the specified positions.
        - Responsibilities:
            - Research specific positions within a company.
            - Find relevant information (blog articles and YouTube interviews) for each position.
            - Provide collected information in a JSON object.
            - Stop searching for additional information once found.
            - Ensure accuracy and avoid generating fake information.
        """
        return Agent(
            role="Company Research Agent",
            goal="""Look up the specific positions for a given company and find urls for 3 recent blog articles and 
                the url and title for 3 recent YouTube interviews for each person in the specified positions. It is your job to return this collected 
