...
llm = ChatOpenAI(temperature=0, api_key="sk-proj-1bELHfK7R8tA5wzNZiXrT3BlbkFJlsWmAgFKgsCM3swObNuh", model= "gpt-3.5-turbo")
...
def decide_to_generate(state):
    ...
    if web_search == "Yes":
        ...
        # Check if there is at least one relevant document
        if filtered_documents:
            # We have relevant documents, so generate answer
            print("---DECISION: GENERATE---")
            return "generate"
        else:
            # No relevant documents found, trigger web search
            print("---DECISION: NO RELEVANT DOCUMENTS FOUND, INCLUDE WEB SEARCH---")
            return "websearch"
...
inputs = {"question": """Parle moi de Identification des Sections de la Documentation  """}
