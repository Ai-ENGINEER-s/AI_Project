...
with open('C:/Users/BARRY/Desktop/AI-WorkSpace/ty/content.txt', 'r', encoding='utf-8') as f:
...
text_splitter = SemanticChunker(
    OpenAIEmbeddings(api_key="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"), breakpoint_threshold_type="percentile" # "standard_deviation", "interquartile"
)
doc_split_content = text_splitter.create_documents([state_of_the_union])
# print(documents)
...
from pprint import pprint
inputs = {"question":" Table 11.5.2: BPM Techniques ?"}
